...
**Digital System of Record Category** means a 4-letter code defined as follows:
...
|------|------------------------|------------------------------|-----------------------------------|---------|
| Bitcoin                                                                                    | SCFN                   | n/a                                           | MOLD                               | Makes only sense on blockchain / DLT, since only blockchain can guarantee the autonomous execution.                                                                                                     |
| Ethereum                                                                                   | SCFN                   | n/a                                           | MOFD                               | Same comment as for Bitcoin.                                                                                                                                                                            |
| USDT stable coin on Ethereum Mainnet                                                      | SFFS                   | T???XX (tbd, see ext. ISO 10962)              | MOFD                               |                                                                                                                                                                                                         |
| Zero Bond as bearer instrument directly issued on Polygon Network as crypto security      | SFFS                   | DBZUFB (ISO 10962)                            | MOFF?                               |                                                                                                                                                                                                         |
| Zero Bond issued via a central securities depository that is booked in investor’s depot in the book-keeping system of investor's custodian bank | RFFS                   | DBZUFB (ISO 10962)                            | SCNC                               |                                                                                                                                                                                                         |
| Zero Bond onramped by a custodian on private/permissioned SWIAT blockchain (tokenized security) | RFFS                   | DBZUFB (ISO 10962)                            | PCFF                               | Note that no matter if a book-entry in depot bank’s system or as tokenized security, the asset type remains the same. The only difference is the Digital System of Record Category.                     |
| Soulbound Token on Ethereum Mainnet                                                       | SUXN                   | tbd                                           | MOFD                               |                                                                                                                                                                                                         |
| Cash Deposit in the Core Banking System of a Bank                                         | SDFS                   | tbd                                           | SCNC                               |                                                                                                                                                                                                         |
| Cash Deposit managed on Ethereum Mainnet                                                  | SFDS                   | tbd                                           | MOFD                               | Note that the only difference lies in the Digital System of Record Category.                                                                                                                             |
